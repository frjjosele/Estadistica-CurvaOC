...
<head>
    ...
    $title['es'] = "Representación de distribuciones estadísticas y Teoremas Límite";
    $title['en'] = "Representing statistical distributions and limit theorems ";
    $title['fr'] = "Représentation des distributions statistiques et théorèmes limites";

    // Set here the page body
    $body['es'] = "Simulación sobre la representación de las principales distribuciones estadísticas, tanto continuas como discretas. También permite realizar cálculo y representación de probabilidades en dichas distribuciones. Asimismo, el applet también cuenta con una simulación de los principales Teoremas Límite, mostrando la convergencia entre algunas distribuciones mediante la representación de sus funciones de densidad y distribución.";
    $body['en'] = "Simulation on the representation of the main statistical distributions, both continuous and discrete. It also allows calculation and representation of probabilities in these distributions. Also, the applet also features a simulation of the main limit theorems, showing the convergence of some distributions by plotting their density and distribution functions.";
    $body['fr'] = "Simulation sur la représentation des principales distributions statistiques, à la fois continu et discret. Il permet également le calcul et la représentation des probabilités dans ces distributions. En outre, l'applet dispose également d'une simulation de la limite principaux théorèmes, montrant la convergence de certaines distributions en traçant leur densité et de distribution.";
    ?>
    ...
    <meta name="description" content="Simulaciones Estadisticas Telematicas">
    <meta name="keywords" content="simulaciones, estadisticas, simulacion, muestreo, probabilidad, azar">
